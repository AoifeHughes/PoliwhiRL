...
def update_for_xy_checkpoints(controller, total_reward, default_reward):
    if controller.get_current_location() in controller.has_reached_reward_locations_xy:
        ...
        if controller.get_XY() in controller.has_reached_reward_locations_xy[controller.get_current_location()]:
            # check if been rewarded for this location_xy
            if controller.has_reached_reward_locations_xy[controller.get_current_location()][controller.get_XY()] == True:
                return total_reward
            else:
