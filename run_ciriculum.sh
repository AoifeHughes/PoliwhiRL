...
start_time=$(date +%s)
python main.py  --episode_length 100 --epochs 1 --num_episodes 250 --N_goals_target 3 --sequence_length 4 --erase false --batch_size 256
end_time=$(date +%s)
runtime=$((end_time-start_time))
...
start_time=$(date +%s)
python main.py  --episode_length 300 --epochs 2 --num_episodes 250 --N_goals_target 4 --sequence_length 8 --erase false --batch_size 256
end_time=$(date +%s)
runtime=$((end_time-start_time))
...
start_time=$(date +%s)
python main.py  --episode_length 500 --epochs 5 --num_episodes 500 --N_goals_target 5 --sequence_length 8 --erase false --batch_size 256
end_time=$(date +%s)
runtime=$((end_time-start_time))
